...
helm install -f ~/thesis/projects/thesis_intern/deployment/backend/k8s/values-t1-threshold0.78.yaml chat-backend ~/thesis/projects/thesis_intern/deployment/backend/k8s
