...
kubectl apply -f ~/thesis/projects/thesis_intern/deployment/llm/k8s/deepseek_7b/deployment.yaml
kubectl apply -f ~/thesis/projects/thesis_intern/deployment/llm/k8s/deepseek_7b/service.yaml
kubectl apply -f ~/thesis/projects/thesis_intern/deployment/llm/k8s/deepseek_7b/pvc.yaml
...
helm install -f ~/thesis/projects/thesis_intern/deployment/backend/k8s/values-t5-deepseek-7b.yaml chat-backend ~/thesis/projects/thesis_intern/deployment/backend/k8s
