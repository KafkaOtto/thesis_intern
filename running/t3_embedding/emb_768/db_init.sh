...
SCHEMA_SCRIPT="$HOME/thesis/projects/thesis_intern/deployment/postgre/scripts/2__schema_script_embd768.sql"
...
kubectl apply -f ~/thesis/projects/thesis_intern/deployment/embedding/k8s/e5_base_v2/deployment_gpu.yaml
...
helm install -f /home/otto/thesis/projects/thesis_intern/deployment/data_importer/k8s/values-t3-e5-base-v2.yaml importer /home/otto/thesis/projects/thesis_intern/deployment/data_importer/k8s
...
kubectl delete -f ~/thesis/projects/thesis_intern/deployment/embedding/k8s/e5_base_v2/deployment_gpu.yaml
kubectl delete -f ~/thesis/projects/thesis_intern/deployment/embedding/k8s/e5_base_v2/service.yaml
kubectl delete -f ~/thesis/projects/thesis_intern/deployment/embedding/k8s/e5_base_v2/pvc.yaml
