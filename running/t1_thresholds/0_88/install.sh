...
helm install -f ~/thesis/projects/thesis_intern/deployment/backend/k8s/values-t1-threshold0.88.yaml chat-backend ~/thesis/projects/thesis_intern/deployment/backend/k8s
