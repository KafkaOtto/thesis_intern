...
kubectl apply -f "$BASE_DIR/deployment/llm/k8s/llama3_1/deployment-prefix-caching.yaml"
...
helm install -f "$BASE_DIR/deployment/backend/k8s/values-t1-threshold0.58.yaml" chat-backend "$BASE_DIR/deployment/backend/k8s"
