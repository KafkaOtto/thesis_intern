...
helm install -f ~/thesis/projects/thesis_intern/deployment/backend/k8s/values-t4-indexing-ivfflat.yaml chat-backend ~/thesis/projects/thesis_intern/deployment/backend/k8s
