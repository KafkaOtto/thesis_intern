...
SCHEMA_SCRIPT="$BASE_DIR/deployment/postgre/scripts/2__schema_script_embd384.sql"
...
kubectl apply -f "$BASE_DIR/deployment/embedding/k8s/e5_small_v2/deployment_gpu.yaml"
...
helm install -f "$BASE_DIR/deployment/data_importer/k8s/values-t3-e5-small-v2.yaml" importer "$BASE_DIR/deployment/data_importer/k8s"
...
kubectl delete -f "$BASE_DIR/deployment/embedding/k8s/e5_small_v2/deployment_gpu.yaml"
kubectl delete -f "$BASE_DIR/deployment/embedding/k8s/e5_small_v2/service.yaml"
kubectl delete -f "$BASE_DIR/deployment/embedding/k8s/e5_small_v2/pvc.yaml"
