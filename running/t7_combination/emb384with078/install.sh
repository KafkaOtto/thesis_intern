...
helm install -f ~/thesis/projects/thesis_intern/deployment/backend/k8s/values-t7-combination.yaml chat-backend ~/thesis/projects/thesis_intern/deployment/backend/k8s
